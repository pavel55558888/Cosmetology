...
public class Consumables {
    ...
    public Consumables(String name, String purchase_price, String expiration_date, String manufacturer, String img, String in_stock, String currentDate, String code) {
        this.name = name;
